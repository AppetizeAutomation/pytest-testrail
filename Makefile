...
clean:
	rm -rf .cache .coverage .tox pytests_py*-test.xml pytest_testrail_appetize.egg-info pytest_testrail_appetize.txt pytests_coverage.xml
...
lint:
	flake8 pytest_testrail_appetize | tee pytest_testrail_appetize.txt
